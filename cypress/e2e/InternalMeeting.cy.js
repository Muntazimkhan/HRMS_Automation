...
describe('Internal Meeting', () => {
  ...
  it('should create and delete an internal meeting', () => {
    ...
    cy.get('div.department_div').contains('.choices__item', 'CPU', { timeout: 10000 })
    ...
    cy.get('div.employee_div').contains('.choices__item', 'Zaki Takia', { timeout: 10000 })
      .should('exist').click({ force: true });
    ...
    cy.get('#date').clear().type('2026-10-09');
